...
public class Advancements {
	...
	public static void register() {
		...
		GENERIC_BEATDEV = new Advancement("bending/beatdev", "Better than the Developer", "Beat the developer with your bending", skull).setParent(GENERIC_RECHOOSE).setHidden(true).setLevel(AdvancementLevel.CHALLENGING);
